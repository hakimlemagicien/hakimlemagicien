...
const LIBRARY_ERROR_MESSAGES: Record<string, string> = {
  ...
  invalid_training_goal: "اختر هدفًا رسميًا معتمدًا قبل الحفظ.",
  reason_required: "اكتب سببًا واضحًا لهذا التعديل.",
  ...
  published_template_immutable: "القالب المنشور لا يُعدَّل مباشرة. أنشئ نسخة جديدة ثم عدّلها.",
  invalid_clone_mode: "نوع النسخ غير صالح.",
  ...
  published_assignment_immutable: "النسخة المنشورة محمية — أنشئ مسودة جديدة ثم عدّل ثم انشر.",
  draft_exists: "يوجد مسودة بالفعل. أكملها أو احذفها قبل إنشاء أخرى.",
  invalid_day_type: "نوع اليوم غير صالح (تدريب أو راحة).",
  assignment_not_editable: "لا يمكن تعديل هذا التعيين في حالته الحالية.",
  allergens_required: "أدخل مسببات الحساسية المعروفة.",
  allergy_status_required: "أكد حالة الحساسية أولاً قبل توليد خطة Strategy V1.",
  invalid_allergy_status: "حالة الحساسية غير صالحة.",
  nutrition_profile_incomplete: "بيانات الجسم من الكويز ناقصة (جنس/طول/وزن/عمر).",
  nutrition_goal_unmapped: "هدف العميل غير مربوط بمحرك التغذية بعد.",
  nutrition_plan_invalid: "خطة التغذية المولّدة غير صالحة للمراجعة.",
  NUTRITION_PROFILE_RESOLUTION_REQUIRED: "تعذر حل ملف التغذية لهذا الهدف — راجع بيانات الجسم.",
  NUTRITION_TARGET_REVIEW_REQUIRED: "أهداف السعرات تحتاج مراجعة قبل التعيين.",
