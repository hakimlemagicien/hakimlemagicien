...
assert(contentBuilderUi.includes("صور المنشور") || contentBuilderUi.includes("إضافة / تغيير"), "multi-image cover upload exists");
assert(contentBuilderUi.includes("أولوية الظهور") || contentBuilderUi.includes("يظهر في الرئيسية"), "content placement controls exist");
assert(contentUi.includes("أعلى") && contentUi.includes("أسفل"), "list can reorder priority");
assert(contentUi.includes("في الرئيسية") || contentUi.includes("featured"), "list can place content on home");
assert(contentUi.includes("حذف نهائي") || contentUi.includes("confirmDeleteDb") || contentUi.includes("deleteAdminDiscoverContent"), "content can be permanently deleted");
assert(contentUi.includes("ترتيب") || contentUi.includes("الأحدث تحديثاً"), "content list supports sorting");
assert(contentUi.includes("cc-cms-tile__hover") && contentUi.includes("تعديل") && contentUi.includes("حذف"), "content tiles expose hover edit/delete/archive");
