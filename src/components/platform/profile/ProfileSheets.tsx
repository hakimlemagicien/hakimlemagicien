...
export function ProfileDeleteAccountFlow({
  ...
  const copy =
    step === 1
      ? "حذف الحساب ≠ إلغاء التجديد ≠ طلب استرداد. سيتم حذف أو إخفاء بيانات حسابك وبرنامجك وصور التقدم وفق سياسة الخصوصية. قد نحتفظ بسجلات مالية أو موافقات أو أمنية للمدة القانونية (TBD_LEGAL_RETENTION)."
      : step === 2
        ? "تأكيد الهوية: هذا الإجراء لا يمكن التراجع عنه من هذه الشاشة. لن يُنفَّذ الحذف النهائي بلمسة واحدة دون هذا التحذير."
        : "هل أنت متأكد من طلب حذف حسابك؟";
