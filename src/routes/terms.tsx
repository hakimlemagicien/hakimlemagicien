    ...
    <LegalPageShell
      ...
      sections={[
        ...
        },
        {
          title: "7. النتائج",
          body: [
            "النتائج تختلف من شخص لآخر وتعتمد على الالتزام والنوم والتغذية والظروف الشخصية.",
            "لا نضمن نتائج محددة (مثل خسارة وزن أو زيادة عضل بكمية معينة) — نضمن تقديم خطة مخصصة ومتابعة حسب الباقة.",
          ],
        },
        {
          title: "8. الملكية الفكرية",
          body: [
            "جميع المحتويات (خطط، فيديوهات، نصوص، تصاميم) ملك لـ Hakim Coaching. يُمنع نسخها أو إعادة بيعها.",
          ],
        },
        {
          title: "9. الإنهاء",
          body: [
            "يمكننا إيقاف الخدمة في حال إساءة الاستخدام أو انتهاك الشروط.",
            "تفاصيل الاسترجاع والإلغاء في سياسة الاسترجاع المنفصلة.",
          ],
        },
        {
          title: "10. القانون الحاكم",
          body: [
            `تخضع هذه الشروط لقوانين ${SITE_JURISDICTION}، مع مراعاة حقوق المستهلك المعمول بها.`,
            `للاستفسارات: ${SITE_SUPPORT_EMAIL}.`,
          ],
        },
      ]}
    />
