...
| **STAGING** | **Canonical (required):** https://staging.hakimlemagicien.com — **PF-4 BLOCKED** (Vercel login + DNS).<br>Do not use Production domain. | `hakim-coaching-staging` | `dxerwrdpcflpnjvsnrjq` | `https://dxerwrdpcflpnjvsnrjq.supabase.co` |
