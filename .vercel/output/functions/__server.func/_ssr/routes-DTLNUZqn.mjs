...
import { n as require_react, t as useComposedRefs } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
...
import { At as ArrowLeft, Ct as CalendarCheck, D as RefreshCw, E as Ruler, Et as BatteryFull, G as Globe, J as Flame, M as MessageSquare, O as Plus, Ot as BadgeCheck, P as MessageCircleQuestionMark, Q as Dumbbell, T as Salad, W as Headphones, _ as Star, _t as ChartLine, at as Clock, b as Shield, bt as Calendar, c as Users, dt as ChevronsLeft, f as Trophy, g as Target, gt as Check, h as TrendingDown, i as Wifi, jt as Activity, kt as Award, l as User, m as TriangleAlert, n as X, o as Utensils, p as TrendingUp, s as UtensilsCrossed, st as ClipboardList, t as Zap, ut as CircleCheck, vt as ChartColumn, w as Scale, x as ShieldCheck, xt as CalendarX, y as Signal } from "../_libs/lucide-react.mjs";
import { n as SiteFooter, t as Header } from "./SiteFooter-y2Y5g7Gu.mjs";
...
import { t as useId } from "../_libs/@radix-ui/react-id+[...].mjs";
import { t as useControllableState } from "../_libs/@radix-ui/react-use-controllable-state+[...].mjs";
import { t as FocusScope } from "../_libs/radix-ui__react-focus-scope.mjs";
import { t as Portal } from "../_libs/radix-ui__react-portal.mjs";
import { t as Presence } from "../_libs/radix-ui__react-presence.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DTLNUZqn.js
...
function CyclingHeroLine({ className = "", variant = "mobile" }) {
	...
	if (variant === "desktop") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		dir: "rtl",
		lang: "ar",
		className: [
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "invisible block whitespace-nowrap select-none lg:text-[40px]",
			"aria-hidden": true,
			children: HERO_WIDTH_HOLDER_PHRASE
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: "absolute right-0 top-0 inline-flex items-center gap-0.5 whitespace-nowrap lg:text-[40px] lg:leading-[1.15]",
...
function ResultCard({ icon: Icon, value, label, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-row-reverse items-center gap-3 rounded-2xl bg-white shadow-soft border border-white px-4 py-3 min-w-[150px]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: `grid h-10 w-10 shrink-0 place-items-center rounded-full ${tone === "success" ? "bg-success-soft text-success" : "bg-primary-soft text-primary"}`,
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CyclingHeroLine, { variant: "desktop" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function CoachVisual() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute z-20 top-[8%] right-[-8px] sm:right-[-20px] animate-float",
...
var confused_coach_default = "/assets/confused-coach-DsyhjSre.png";
var PROBLEMS = [
	{
		title: "برامج عشوائية",
...
function useInView$6(threshold = .15) {
	const ref = (0, import_react.useRef)(null);
	const [inView, setInView] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const el = ref.current;
...
function ProblemSection() {
	const { ref, inView } = useInView$6(.12);
...
function useInView$5(threshold = .2) {
	const ref = (0, import_react.useRef)(null);
	const [inView, setInView] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const el = ref.current;
...
function Results90() {
	const { ref: sectionRef, inView } = useInView$5(.1);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		ref: sectionRef,
...
function BottomStats() {
	const { ref, inView } = useInView$5(.3);
...
function useInView$4(opts = { threshold: .15 }) {
	const ref = (0, import_react.useRef)(null);
	const [inView, setInView] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
...
function HowItWorks() {
	const { ref: secRef, inView: secIn } = useInView$4({ threshold: .05 });
...
function WhatYouGet() {
	const head = useInView$3(.1);
	const cards = useInView$3(.1);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		id: "features",
		dir: "rtl",
...
function useInView$2(threshold = .12) {
	const ref = (0, import_react.useRef)(null);
	const [inView, setInView] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const el = ref.current;
...
function PricingTransparency() {
	const head = useInView$2();
	const cards = useInView$2();
	const trust = useInView$2();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		id: "pricing",
		dir: "rtl",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: STEPS.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: `group relative overflow-hidden rounded-[24px] bg-white p-5 ring-1 ring-neutral-100 shadow-[0_8px_28px_-12px_rgba(15,23,42,0.12)] transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-[0_16px_40px_-12px_rgba(249,115,22,0.28)] hover:ring-orange-100 md:p-6 ${cards.inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`,
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "mt-4 text-[18px] font-black leading-snug text-neutral-900 md:text-[19px]",
										children: item.title
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-2.5 text-[13.5px] leading-[1.75] text-neutral-600 md:text-[14px]",
										children: item.desc
									})
								]
							})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative overflow-hidden rounded-[28px] border border-[#FF6B00]/15 bg-gradient-to-br from-[#FFF8F2] via-white to-[#FFF6EE] p-6 shadow-[0_14px_40px_-20px_rgba(255,107,0,0.35)] md:p-8",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								"aria-hidden": true,
								className: "pointer-events-none absolute -left-10 -top-10 h-32 w-32 rounded-full bg-[#FF6B00]/10 blur-3xl"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative flex flex-col items-stretch gap-4 sm:flex-row sm:items-start sm:gap-5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "grid h-14 w-14 shrink-0 place-items-center self-center rounded-2xl bg-gradient-to-br from-[#FF6B00] to-[#FF8A3D] shadow-[0_12px_28px_-12px_rgba(255,107,0,0.55)] sm:self-start",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										...
										children: "شفافية كاملة في التسعير"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-2.5 text-[13.5px] leading-[1.8] text-neutral-600 md:text-[15px]",
										children: "نؤمن بالشفافية الكاملة. سيتم عرض سعر اشتراكك النهائي وجميع المزايا المشمولة وتفاصيل الفوترة قبل أي عملية دفع، دون أي رسوم مخفية."
									})]
								})]
							})]
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-5 w-5 transition-transform group-hover:-translate-x-1" }), "ابدأ التقييم"]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mx-auto mt-6 max-w-3xl text-center text-[11.5px] leading-relaxed text-neutral-500 md:mt-8 md:text-[12.5px]",
						children: "جميع الأسعار تُعرض بوضوح قبل الدفع، ويمكنك مراجعة تفاصيل الاشتراك كاملة قبل تأكيد عملية الشراء."
					})
				]
			})
		]
